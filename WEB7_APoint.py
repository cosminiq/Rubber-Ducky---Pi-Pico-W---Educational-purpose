...
time.sleep(5)  # wait for serial etc.
print(f"Web Workflow is enabled, and this Station is connected to an external AP:")
print(wifi.radio.ipv4_address)
print(f"Stopping this Station and starting an AP:")
wifi.radio.stop_station()
wifi.radio.start_ap("Pi_Pico_duck", "autoturism")
...
def welcome_msg():
    ...
    lcd.print(str(wifi.radio.ipv4_address_ap))
welcome_msg()
#=======================================================================================================
...
print(f"Listening on http://{wifi.radio.ipv4_address_ap}/html/Web_app.html")
